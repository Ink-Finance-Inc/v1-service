...
func newUser(db *gorm.DB) user {
	...
	_user.MainAccounts = field.NewString(tableName, "main_accounts")
	_user.ChainType = field.NewString(tableName, "chain_type")
	_user.ChainID = field.NewInt32(tableName, "chain_id")
	_user.CreateTime = field.NewTime(tableName, "create_time")
	_user.Valid = field.NewInt32(tableName, "valid")
...
func (u *user) updateTableName(table string) *user {
	...
	u.MainAccounts = field.NewString(table, "main_accounts")
	u.ChainType = field.NewString(table, "chain_type")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["id"] = u.ID
	u.fieldMap["main_accounts"] = u.MainAccounts
	u.fieldMap["chain_type"] = u.ChainType
